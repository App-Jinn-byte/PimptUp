...
extension AddCarViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate{
    ...
    func addCar() {
        ...
        if (editableCar == nil){
             ...
             url = "http://pimptup.jinnbytedev.com/api/Mobile/AddUserVehicleWithImage"
        }
        else {
             parameters = [
                "UserId": Constants.userId,
             ...
             url = "http://pimptup.jinnbytedev.com/api/Mobile/UpdateUserVehicleWithImage"
                    ...
                    DispatchQueue.main.async {
                        do{
                            if response.result.error == nil {
                                ...
                                if (self.editableCar == nil ){
                                Constants.Alert(title: "Upload Complete", message: "Your Vehicle has been added to your Profile", controller: self, action: self.handlerSuccess())
                                }
                                else{
                                    Constants.Alert(title: "Upload Complete", message: "Your Vehicle has been Updated", controller: self, action: self.handlerSuccess())
                                }
                            }
                            else {
